	...
	<div class="addEdit-block" :style='{"padding":"30px","backgroundAttachment":"fixed","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230312/52c1bcab43064c72aa492e0f342d2666.jpg)","flexDirection":"row-reverse","display":"flex","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="缴费项目" prop="jiaofeixiangmu">
					<el-input v-model="ruleForm.jiaofeixiangmu" placeholder="缴费项目" clearable  :readonly="ro.jiaofeixiangmu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="缴费项目" prop="jiaofeixiangmu">
					<el-input v-model="ruleForm.jiaofeixiangmu" placeholder="缴费项目" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="缴费金额" prop="jiaofeijine">
					<el-input v-model="ruleForm.jiaofeijine" placeholder="缴费金额" clearable  :readonly="ro.jiaofeijine"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="缴费金额" prop="jiaofeijine">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="缴费说明" prop="jiaofeishuoming">
					<el-input v-model="ruleForm.jiaofeishuoming" placeholder="缴费说明" clearable  :readonly="ro.jiaofeishuoming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="缴费说明" prop="jiaofeishuoming">
					<el-input v-model="ruleForm.jiaofeishuoming" placeholder="缴费说明" readonly></el-input>
				</el-form-item>
			</template>
	...
	data() {
		...
		return {
			...
			ro:{
				...
				jiaofeixiangmu : false,
				xuehao : false,
				xingming : false,
				jiaofeijine : false,
				fabushijian : false,
				jiaofeishuoming : false,
			},
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jiaofeixiangmu'){
							this.ruleForm.jiaofeixiangmu = obj[o];
							this.ro.jiaofeixiangmu = true;
							continue;
						}
						if(o=='xuehao'){
						...
						if(o=='jiaofeishuoming'){
							this.ruleForm.jiaofeishuoming = obj[o];
							this.ro.jiaofeishuoming = true;
							continue;
						}
				}
