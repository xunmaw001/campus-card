<template>
	<div class="addEdit-block" :style='{"padding":"30px","backgroundAttachment":"fixed","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230312/52c1bcab43064c72aa492e0f342d2666.jpg)","flexDirection":"row-reverse","display":"flex","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="器材名称" prop="qicaimingcheng">
					<el-input v-model="ruleForm.qicaimingcheng" placeholder="器材名称" clearable  :readonly="ro.qicaimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="器材名称" prop="qicaimingcheng">
					<el-input v-model="ruleForm.qicaimingcheng" placeholder="器材名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="器材类型" prop="qicaileixing">
					<el-input v-model="ruleForm.qicaileixing" placeholder="器材类型" clearable  :readonly="ro.qicaileixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="器材类型" prop="qicaileixing">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="借用时长" prop="jieyongshizhang">
					<el-input v-model="ruleForm.jieyongshizhang" placeholder="借用时长" clearable  :readonly="ro.jieyongshizhang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="借用时长" prop="jieyongshizhang">
					<el-input v-model="ruleForm.jieyongshizhang" placeholder="借用时长" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="借用时间" prop="jieyongshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jieyongshijian" label="借用时间" prop="jieyongshijian">
					<el-input v-model="ruleForm.jieyongshijian" placeholder="借用时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="借用说明" prop="jieyongshuoming">
					<el-input v-model="ruleForm.jieyongshuoming" placeholder="借用说明" clearable  :readonly="ro.jieyongshuoming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="借用说明" prop="jieyongshuoming">
					<el-input v-model="ruleForm.jieyongshuoming" placeholder="借用说明" readonly></el-input>
				</el-form-item>
	...
	data() {
		...
		return {
			...
			ro:{
				...
				qicaileixing : false,
				shuliang : false,
				jieyongshizhang : false,
				jieyongshijian : false,
				jieyongshuoming : false,
				xuehao : false,
				xingming : false,
				shouji : false,
				sfsh : false,
			...
			rules: {
				...
				jieyongshizhang: [
					{ required: true, message: '借用时长不能为空', trigger: 'blur' },
				],
				jieyongshijian: [
				],
				jieyongshuoming: [
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jieyongshizhang'){
							this.ruleForm.jieyongshizhang = obj[o];
							this.ro.jieyongshizhang = true;
							continue;
						}
						if(o=='jieyongshijian'){
						...
						if(o=='jieyongshuoming'){
							this.ruleForm.jieyongshuoming = obj[o];
							this.ro.jieyongshuoming = true;
							continue;
						}
						if(o=='xuehao'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `qicaijieyong/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.qicaijieyongCrossAddOrUpdateFlag = false;
						 this.parent.search();
