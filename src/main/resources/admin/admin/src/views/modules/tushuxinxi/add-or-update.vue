<template>
	<div class="addEdit-block" :style='{"padding":"30px","backgroundAttachment":"fixed","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230312/52c1bcab43064c72aa492e0f342d2666.jpg)","flexDirection":"row-reverse","display":"flex","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="图书编号" prop="tushubianhao">
					<el-input v-model="ruleForm.tushubianhao" placeholder="图书编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.tushubianhao" label="图书编号" prop="tushubianhao">
					<el-input v-model="ruleForm.tushubianhao" placeholder="图书编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="可借数量" prop="kejieshuliang">
					<el-input v-model="ruleForm.kejieshuliang" placeholder="可借数量" clearable  :readonly="ro.kejieshuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="可借数量" prop="kejieshuliang">
					<el-input v-model="ruleForm.kejieshuliang" placeholder="可借数量" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="借阅须知" prop="jieyuexuzhi">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="借阅须知"
					  v-model="ruleForm.jieyuexuzhi" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.jieyuexuzhi" label="借阅须知" prop="jieyuexuzhi">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.jieyuexuzhi}}</span>
				</el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jieyuexuzhi'){
							this.ruleForm.jieyuexuzhi = obj[o];
							this.ro.jieyuexuzhi = true;
							continue;
						}
						if(o=='tushujieshao'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.tushujieshao = this.ruleForm.tushujieshao.replace(reg,'../../../springbootq7e7o/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
