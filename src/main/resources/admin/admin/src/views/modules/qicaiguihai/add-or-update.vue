	...
	<div class="addEdit-block" :style='{"padding":"30px","backgroundAttachment":"fixed","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230312/52c1bcab43064c72aa492e0f342d2666.jpg)","flexDirection":"row-reverse","display":"flex","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="归还数量" prop="guihaishuliang">
					<el-input v-model="ruleForm.guihaishuliang" placeholder="归还数量" clearable  :readonly="ro.guihaishuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="归还数量" prop="guihaishuliang">
					<el-input v-model="ruleForm.guihaishuliang" placeholder="归还数量" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="归还说明" prop="guihaishuoming">
					<el-input v-model="ruleForm.guihaishuoming" placeholder="归还说明" clearable  :readonly="ro.guihaishuoming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="归还说明" prop="guihaishuoming">
					<el-input v-model="ruleForm.guihaishuoming" placeholder="归还说明" readonly></el-input>
				</el-form-item>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				guihaishuoming: [
					{ required: true, message: '归还说明不能为空', trigger: 'blur' },
				],
				guihaishijian: [
				],
				xuehao: [
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='guihaishuliang'){
							this.ruleForm.guihaishuliang = obj[o];
							this.ro.guihaishuliang = true;
							continue;
						}
						if(o=='guihaishuoming'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `qicaiguihai/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.qicaiguihaiCrossAddOrUpdateFlag = false;
						 this.parent.search();
