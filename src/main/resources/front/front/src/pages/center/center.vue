    ...
    <el-tabs tab-position="left" :style='{"boxShadow":"0 2px 4px rgba(0,0,0,.1)","padding":"12px 0 0","margin":"20px 0 40px","borderColor":"#52b646","borderRadius":"8px","background":"#f5f5f5","borderWidth":"4px","borderStyle":"dashed dotted solid double"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="80px">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xuesheng'" label="密码" prop="mima">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xuesheng'" label="性别">
            <el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xuesheng'" label="学校" prop="xuexiao">
            <el-input v-model="sessionForm.xuexiao" placeholder="学校" ></el-input>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      if ('xuesheng' == this.userTableName) {
        this.$set(this.sessionForm, 'xuexiao', null);
      }
      if ('xuesheng' == this.userTableName) {
