...
<div :style='{"padding":"20px 20px 40px","margin":"10px auto 0","borderColor":"#52b646","borderRadius":"12px","background":"#fff","borderWidth":"3px","width":"1200px","position":"relative","borderStyle":"solid dashed double double"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="可借数量" prop="kejieshuliang">
            <el-input v-model="ruleForm.kejieshuliang" 
                placeholder="可借数量" clearable ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="借阅日期" prop="jieyueriqi" disabled>
              <el-date-picker
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="归还日期" prop="guihairiqi" >
              <el-date-picker
                  format="yyyy 年 MM 月 dd 日"
                  value-format="yyyy-MM-dd"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="借阅说明" prop="jieyueshuoming">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="借阅说明"
              v-model="ruleForm.jieyueshuoming">
            </el-input>
          </el-form-item>
  ...
  export default {
    ...
    // 多级联动参数
      ...
      onSubmit() {
        ...
        if(this.ruleForm.shuliang>this.ruleForm.kejieshuliang){
          this.$message.error("数量不能超过可借数量");
          return
        }
        var obj = JSON.parse(localStorage.getItem('crossObj'));
