...
<div :style='{"padding":"20px 20px 40px","margin":"10px auto 0","borderColor":"#52b646","borderRadius":"12px","background":"#fff","borderWidth":"3px","width":"1200px","position":"relative","borderStyle":"solid dashed double double"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="缴费项目" prop="jiaofeixiangmu">
            <el-input v-model="ruleForm.jiaofeixiangmu" 
                placeholder="缴费项目" clearable ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="缴费金额" prop="jiaofeijine">
            <el-input v-model="ruleForm.jiaofeijine" 
                placeholder="缴费金额" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="发布时间" prop="fabushijian" disabled>
              <el-date-picker
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="缴费说明" prop="jiaofeishuoming">
            <el-input v-model="ruleForm.jiaofeishuoming" 
                placeholder="缴费说明" clearable ></el-input>
          </el-form-item>
