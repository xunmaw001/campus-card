...
public class TushuguihaiController {
    ...
    public R page(@RequestParam Map<String, Object> params,TushuguihaiEntity tushuguihai,
		...
		if(tableName.equals("xuesheng")) {
			tushuguihai.setXuehao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R update(@RequestBody Long[] ids, @RequestParam String sfsh, @RequestParam String shhf){
        List<TushuguihaiEntity> list = new ArrayList<TushuguihaiEntity>();
        for(Long id : ids) {
            TushuguihaiEntity tushuguihai = tushuguihaiService.selectById(id);
            tushuguihai.setSfsh(sfsh);
            tushuguihai.setShhf(shhf);
            list.add(tushuguihai);
        }
        tushuguihaiService.updateBatchById(list);
        return R.ok();
    }
